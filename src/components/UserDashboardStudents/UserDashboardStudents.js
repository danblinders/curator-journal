...
const StudentItem =  ({studentInfo, parents, id}) => {
  ...
  const updateValue = (table, col, val, check_col, check_val) => {
    axios.post('https://curator-backend.onrender.com/update ', {table_name: table, table_col: col, table_val: val, table_check_col: check_col, table_check_val: check_val}).then(response => {
